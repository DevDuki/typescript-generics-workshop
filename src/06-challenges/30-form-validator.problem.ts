...
const makeFormValidatorFactory =
  <TValidatorName  extends string>(validators: Record<TValidatorName, (value: string ) => string | void>) =>
  <TProperty extends string>(config: Record<TProperty, Array<TValidatorName>>) => {
